...
import (
	...
	extHello "github.com/J0taFerreira/my-grpc-proto/protogen/go/hello"
...
func request_HelloService_SayManyHellos_0(ctx context.Context, marshaler runtime.Marshaler, client extHello.HelloServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extHello.HelloRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.SayManyHellos(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_HelloService_SayManyHellos_0(ctx context.Context, marshaler runtime.Marshaler, server extHello.HelloServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extHello.HelloRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.SayManyHellos(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterHelloServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extHello.HelloServiceServer) error {
	...
	mux.Handle("POST", pattern_HelloService_SayManyHellos_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/hello.HelloService/SayManyHellos", runtime.WithHTTPPathPattern("/hello.HelloService/SayManyHellos"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_HelloService_SayManyHellos_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_HelloService_SayManyHellos_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	forward_HelloService_SayManyHellos_0 = runtime.ForwardResponseMessage
)
